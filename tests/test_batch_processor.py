...
from cja_sdr_generator import BatchProcessor, ProcessingResult
...
class TestBatchProcessorProcessBatch:
    ...
    @patch('cja_sdr_generator.setup_logging')
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_process_batch_single_success(self, mock_tqdm, mock_executor, mock_setup_logging,
                                           mock_config_file, temp_output_dir, successful_result):
        ...
        with patch('cja_sdr_generator.as_completed', return_value=[mock_future]):
            processor = BatchProcessor(
                config_file=mock_config_file,
                output_dir=temp_output_dir
            )
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_process_batch_single_failure(self, mock_tqdm, mock_executor, mock_setup_logging,
                                           mock_config_file, temp_output_dir, failed_result):
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_process_batch_mixed_results(self, mock_tqdm, mock_executor, mock_setup_logging,
        ...
        with patch('cja_sdr_generator.as_completed', return_value=[mock_future1, mock_future2]):
            processor = BatchProcessor(
                config_file=mock_config_file,
                output_dir=temp_output_dir,
                continue_on_error=True
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_process_batch_exception_handling(self, mock_tqdm, mock_executor, mock_setup_logging,
                                               mock_config_file, temp_output_dir):
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_process_batch_calculates_total_duration(self, mock_tqdm, mock_executor, mock_setup_logging,
                                                      mock_config_file, temp_output_dir, successful_result):
...
class TestBatchProcessorPrintSummary:
    ...
    def test_print_summary_all_successful(self, mock_print, mock_setup_logging,
                                           mock_config_file, temp_output_dir, successful_result):
    ...
    @patch('cja_sdr_generator.setup_logging')
    @patch('builtins.print')
    def test_print_summary_with_failures(self, mock_print, mock_setup_logging,
                                          mock_config_file, temp_output_dir,
                                          successful_result, failed_result):
    ...
    @patch('cja_sdr_generator.setup_logging')
    @patch('builtins.print')
    def test_print_summary_calculates_success_rate(self, mock_print, mock_setup_logging,
                                                    mock_config_file, temp_output_dir,
                                                    successful_result, failed_result):
    ...
    @patch('cja_sdr_generator.setup_logging')
    @patch('builtins.print')
    def test_print_summary_empty_results(self, mock_print, mock_setup_logging,
                                          mock_config_file, temp_output_dir):
    ...
    @patch('cja_sdr_generator.setup_logging')
    @patch('builtins.print')
    def test_print_summary_calculates_total_file_size(self, mock_print, mock_setup_logging,
                                                       mock_config_file, temp_output_dir):
        ...
        result1 = ProcessingResult(
            data_view_id="dv_1", data_view_name="DV1", success=True,
            duration=1.0, file_size_bytes=1024
        )
        result2 = ProcessingResult(
            data_view_id="dv_2", data_view_name="DV2", success=True,
            duration=1.0, file_size_bytes=2048
        )
...
class TestBatchProcessorWorkerArgs:
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_worker_args_include_all_settings(self, mock_tqdm, mock_executor, mock_setup_logging,
                                               mock_config_file, temp_output_dir, successful_result):
...
class TestBatchProcessorEdgeCases:
    ...
    @patch('cja_sdr_generator.ProcessPoolExecutor')
    @patch('cja_sdr_generator.tqdm')
    def test_empty_data_view_list(self, mock_tqdm, mock_executor, mock_setup_logging,
                                   mock_config_file, temp_output_dir):
        ...
        with patch('cja_sdr_generator.as_completed', return_value=[]):
            processor = BatchProcessor(
                config_file=mock_config_file,
                output_dir=temp_output_dir
            )
