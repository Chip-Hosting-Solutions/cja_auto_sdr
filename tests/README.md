...
**Total: 1,381 comprehensive tests**
...
| `test_cli.py` | 183 | Command-line interface and argument parsing |
...
| **Total** | **1,381** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,381 tests total)
