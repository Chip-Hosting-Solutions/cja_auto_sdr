...
**Total: 1,407 comprehensive tests**
...
| `test_cli.py` | 205 | Command-line interface and argument parsing |
...
| **Total** | **1,407** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,407 tests total)
