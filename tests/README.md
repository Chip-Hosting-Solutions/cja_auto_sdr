...
**Total: 1,416 comprehensive tests**
...
| `test_cli.py` | 214 | Command-line interface and argument parsing |
...
| **Total** | **1,416** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,416 tests total)
