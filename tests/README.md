...
**Total: 4,618 comprehensive tests**
...
| `test_cli.py` | 247 | Command-line interface and argument parsing |
...
| **Total** | **4,618** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (4,618 tests total)
