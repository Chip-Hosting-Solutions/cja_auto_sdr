...
**Total: 5,410 comprehensive tests**
...
| `test_cli.py` | 413 | Command-line interface and argument parsing |
...
| **Total** | **5,410** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (5,410 tests total)
