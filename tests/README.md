...
**Total: 1,409 comprehensive tests**
...
| `test_cli.py` | 207 | Command-line interface and argument parsing |
...
| **Total** | **1,409** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,409 tests total)
