...
**Total: 1,401 comprehensive tests**
...
| `test_cli.py` | 203 | Command-line interface and argument parsing |
...
| **Total** | **1,401** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,401 tests total)
