...
**Total: 5,412 comprehensive tests**
...
| `test_cli.py` | 415 | Command-line interface and argument parsing |
...
| **Total** | **5,412** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (5,412 tests total)
