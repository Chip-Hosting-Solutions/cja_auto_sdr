...
**Total: 1,379 comprehensive tests**
...
| `test_cli.py` | 181 | Command-line interface and argument parsing |
...
| **Total** | **1,379** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,379 tests total)
