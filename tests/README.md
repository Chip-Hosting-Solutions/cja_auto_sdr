...
**Total: 4,697 comprehensive tests**
...
| `test_cli.py` | 274 | Command-line interface and argument parsing |
...
| **Total** | **4,697** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (4,697 tests total)
