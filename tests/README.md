...
**Total: 4,701 comprehensive tests**
...
| `test_cli.py` | 278 | Command-line interface and argument parsing |
...
| **Total** | **4,701** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (4,701 tests total)
