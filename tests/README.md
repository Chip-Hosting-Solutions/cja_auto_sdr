...
**Total: 4,621 comprehensive tests**
...
| `test_cli.py` | 250 | Command-line interface and argument parsing |
...
| `test_cli_command_handlers.py` | 73 | CLI dispatch for --stats, --org-report, --list-snapshots, diff config unpacking |
...
| `test_main_impl_coverage.py` | 53 | _main_impl coverage edge cases |
...
| **Total** | **4,621** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (4,621 tests total)
