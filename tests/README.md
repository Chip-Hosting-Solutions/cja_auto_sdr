...
**Total: 1,376 comprehensive tests**
...
| `test_cli.py` | 178 | Command-line interface and argument parsing |
...
| **Total** | **1,376** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,376 tests total)
