...
**Total: 1,383 comprehensive tests**
...
| `test_cli.py` | 185 | Command-line interface and argument parsing |
...
| **Total** | **1,383** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (1,383 tests total)
