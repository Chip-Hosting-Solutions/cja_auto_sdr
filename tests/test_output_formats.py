...
def _get_excel_sheet_names(file_path: str) -> list[str]:
    ...
    return [sheet.attrib["name"] for sheet in root.findall("x:sheets/x:sheet", XLSX_NS)]
...
class TestCSVOutput:
    ...
    def test_csv_output_creates_directory(self, tmp_path, sample_data_dict):
        ...
        output_path = write_csv_output(sample_data_dict, "test_dataview", str(tmp_path), logger)
    ...
    def test_csv_output_creates_all_files(self, tmp_path, sample_data_dict):
        ...
        expected_files = ["metadata.csv", "data_quality.csv", "dataview_details.csv", "metrics.csv", "dimensions.csv"]
...
class TestJSONOutput:
    ...
    def test_json_output_creates_file(self, tmp_path, sample_data_dict, sample_metadata_dict):
        ...
        output_path = write_json_output(sample_data_dict, sample_metadata_dict, "test_dataview", str(tmp_path), logger)
...
class TestHTMLOutput:
    ...
    def test_html_output_creates_file(self, tmp_path, sample_data_dict, sample_metadata_dict):
        ...
        output_path = write_html_output(sample_data_dict, sample_metadata_dict, "test_dataview", str(tmp_path), logger)
    ...
    def test_html_escapes_special_characters(self, tmp_path, sample_metadata_dict):
        ...
        metadata_dict_with_special = {"Test <tag>": "Value <test>", "Normal": "Value"}

        data_dict = {"Test Data": pd.DataFrame([{"name": "Test Data", "value": "Safe&Sound"}])}
...
class TestExcelOutput:
    ...
    def test_excel_output_creates_file(self, tmp_path, sample_data_dict):
        ...
        output_path = write_excel_output(sample_data_dict, "test_dataview", str(tmp_path), logger)
    ...
    def test_excel_output_empty_sheet_uses_placeholder(self, tmp_path):
        ...
        output_path = write_excel_output(data_dict, "test_empty", str(tmp_path), logger)
...
class TestEdgeCases:
    ...
    def test_large_datasets(self, tmp_path):
        ...
        csv_path = write_csv_output(data_dict, "test", str(tmp_path), logger)
        json_path = write_json_output(data_dict, metadata_dict, "test", str(tmp_path), logger)
        write_html_output(data_dict, metadata_dict, "test", str(tmp_path), logger)
...
class TestMarkdownOutput:
    ...
    def test_markdown_collapsible_sections(self, tmp_path):
        ...
        large_df = pd.DataFrame({"id": [f"id_{i}" for i in range(100)], "name": [f"Name {i}" for i in range(100)]})
    ...
    def test_markdown_handles_empty_dataframes(self, tmp_path):
        ...
        data_dict = {"Empty Table": pd.DataFrame()}
        metadata_dict = {}
