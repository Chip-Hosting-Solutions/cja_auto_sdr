...
SUMMARY
                     Source: Production Analytics (dv_12345) Target: Staging Analytics (dv_67890)     Added    Removed   Modified   Unchanged     Changed
-----------------------------------------------------------------------------------------------------------------------------------------------------------
...
```
SUMMARY
                     Source: Source Data View (dv_source) Target: Target Data View (dv_target)     Added    Removed   Modified   Unchanged     Changed
-------------------------------------------------------------------------------------------------------------------------------------------------------
