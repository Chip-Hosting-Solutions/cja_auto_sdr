...
<body>
    <div class="header">
        ...
        <p style="margin: 10px 0 0 0; opacity: 0.9;">Generated with v{__version__}</p>
    </div>
...
"""
    ...
    <div class="footer">
        <p>Generated by CJA Auto SDR Generator v{__version__}</p>
...
def main():
    print("=" * 70)
    print(f"  Creating Sample Output Files - v{__version__}")
    print("=" * 70)
